...
<div class="sidebar">
      <nav class="sidebar-nav">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a href="{{ url('/validador/validarAlumnes') }}"><i class="icon-list"></i> Validar alumnes </a>
          </li>
          <li class="nav-item">
            <a href="{{ url('/validador/validarEmpreses') }}"><i class="icon-list"></i> Validar empreses </a>
          </li>
          ...
          <li class="nav-item">
            <a href="{{ url('/validador/validarOfertes') }}"><i class="icon-graph"></i> Validar ofertes </a>
          </li>
        </ul>
      </nav>
    </div>

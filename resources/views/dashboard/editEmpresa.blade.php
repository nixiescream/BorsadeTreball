...
<div class="sidebar">
      <nav class="sidebar-nav">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a href="{{ url('/empresa/editarempresa',$empresa->user_id) }}" class="nav-link" active><i class="icon-graph"></i> Ofertes aplicades </a>
          </li>
          ...
          <li class="nav-item">
            <a href="{{ url('/empresa/editarempresa',$empresa->user_id) }}" class="nav-link" active><i class="icon-list"></i> Llistat d'ofertes </a>
          </li>
        </ul>
      </nav>
    </div>

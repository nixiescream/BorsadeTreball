...
<div class="sidebar">
      <nav class="sidebar-nav">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link" <?php if($empresa->empresa_validat == 0): ?>
                class="disabled"
                <?php endif; ?>><i class="icon-graph"></i> Crear oferta </a>
          </li>
...
<div class="content container-fluid">
    <div class="card border-info mb-3 rounded">
        ...
        <div class="card-body">
            <h5 class="card-title"><?php echo e($empresa->empresa_nom); ?> <?php echo e($empresa->empresa_cognom1); ?> <?php echo e($empresa->empresa_cognom2); ?></h5>
        </div>
    </div>
</div>
<div class="content container-fluid">

...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
        <img src="<?php echo e(asset('images/ESCUTColor2.png')); ?>" id="logo"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="btn btn-primary-outline js-scroll-trigger" href="<?php echo e(url('login')); ?>">Login</a>
                </li>
            </ul>
        </div>
    </div>
...
<?php echo $__env->make('layouts.princ', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>